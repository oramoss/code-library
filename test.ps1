...
Write-Verbose "STARTING..."
        ...
        {
Write-Verbose "connect-azaccount..."
            Connect-AzAccount
        } else {
Write-Verbose "clientid is empty/null..."
...
Write-Verbose "Get-AzContext..."
        Get-AzContext -SubscriptionId $SubscriptionId

        $alreadyExists = $true;
        try {
Write-Verbose get-azresourcegroup... rg found"
            Get-AzResourceGroup -Name $ResourceGroupName
            Write-Verbose "Resource group was found, will delete and recreate it."
        }
        catch {
Write-Verbose "get-azresourcegroup...rg not found"
